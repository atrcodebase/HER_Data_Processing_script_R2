...
hf_t1_data <- apply_log(data = hf_t1_data, log=filter(correction_log_filtered, Tool == "Tool 1.1" & Tab_Name == "data"),
                        data_KEY = "KEY",
...
hf_injuries <- apply_log(data = hf_injuries, log=filter(correction_log_filtered, Tool == "Tool 1.1" & Tab_Name == "Injuries_Details"),
                        data_KEY = "KEY",
                        log_columns = c(question = "question",
                                        old_value = "old_value",
                                        new_value = "new_value",
...
hf_incidents <- apply_log(data = hf_incidents, log=filter(correction_log_filtered, Tool == "Tool 1.1" & Tab_Name == "Incidents"),
                         data_KEY = "KEY",
                         log_columns = c(question = "question",
                                         old_value = "old_value",
                                         new_value = "new_value",
...
hf_fatalities <- apply_log(data = hf_fatalities, log=filter(correction_log_filtered, Tool == "Tool 1.1" & Tab_Name == "Fatalities_Details"),
                          data_KEY = "KEY",
                          log_columns = c(question = "question",
                                          old_value = "old_value",
                                          new_value = "new_value",
...
hf_t2_data <- apply_log(data = hf_t2_data, log=filter(correction_log_filtered, Tool == "Tool 1.2" & Tab_Name == "data"),
                        data_KEY = "KEY",
                        log_columns = c(question = "question",
                                        old_value = "old_value",
                                        new_value = "new_value",
...
hf_t2_photos <- apply_log(data = hf_t2_photos, log=filter(correction_log_filtered, Tool == "Tool 1.2" & Tab_Name == "Photos_Of_Handwashing_Stations"),
                        data_KEY = "KEY",
                        log_columns = c(question = "question",
                                        old_value = "old_value",
                                        new_value = "new_value",
...
hf_t3_data <- apply_log(data = hf_t3_data, log=filter(correction_log_filtered, Tool == "Tool 1.3" & Tab_Name == "data"), 
                        data_KEY = "KEY",
                        log_columns = c(question = "question",
                                        old_value = "old_value",
                                        new_value = "new_value",
...
t2_data <- apply_log(data = t2_data, log=filter(correction_log_filtered, Tool == "Tool 2" & Tab_Name == "data"), 
                        data_KEY = "KEY",
                        log_columns = c(question = "question",
                                        old_value = "old_value",
                                        new_value = "new_value",
...
t2_income <- apply_log(data = t2_income, log=filter(correction_log_filtered, Tool == "Tool 2" & Tab_Name == "Income_Earning_Members_Details"), 
                     data_KEY = "KEY",
                     log_columns = c(question = "question",
                                     old_value = "old_value",
                                     new_value = "new_value",
...
t2_illness <- apply_log(data = t2_illness, log=filter(correction_log_filtered, Tool == "Tool 2" & Tab_Name == "Illness_Details"), 
                     data_KEY = "KEY",
                     log_columns = c(question = "question",
                                     old_value = "old_value",
                                     new_value = "new_value",
...
t2_injuries <- apply_log(data = t2_injuries, log=filter(correction_log_filtered, Tool == "Tool 2" & Tab_Name == "Injuries_Details"), 
                     data_KEY = "KEY",
                     log_columns = c(question = "question",
                                     old_value = "old_value",
                                     new_value = "new_value",
...
t2_immunization <- apply_log(data = t2_immunization, log=filter(correction_log_filtered, Tool == "Tool 2" & Tab_Name == "Immunization_Details"), 
                     data_KEY = "KEY",
                     log_columns = c(question = "question",
                                     old_value = "old_value",
                                     new_value = "new_value",
...
t2_other <- apply_log(data = t2_other, log=filter(correction_log_filtered, Tool == "Tool 2" & Tab_Name == "Section_B6_Other_Group"), 
                             data_KEY = "KEY",
                             log_columns = c(question = "question",
                                             old_value = "old_value",
                                             new_value = "new_value",
...
t3_data <- apply_log(data = t3_data, log=filter(correction_log_filtered, Tool == "Tool 3" & Tab_Name == "data"), 
                     data_KEY = "KEY",
                     log_columns = c(question = "question",
                                     old_value = "old_value",
                                     new_value = "new_value",
